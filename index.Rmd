...
The first part of this project is to tidy up the "genel" dataset to give values from the 2020 election only. Since we are not interested in the candidates running but rather the party, the "candidates" column should be removed. 
